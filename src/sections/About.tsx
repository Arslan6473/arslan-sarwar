    ...
    <div id="about" className="py-20 lg:py-28">
      <div className="container">
        ...
        <p className="text-center text-white/60 mt-4 md:text-lg lg:text-xl max-w-md mx-auto">
          Learn more about who I am, what I do, and wht Inspires me.{" "}
        </p>
        <div className="mt-20 flex flex-col gap-8">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-5 lg:grid-cols-3 ">
            <Card className="h-[350px] md:col-span-2 lg:col-span-1">
              ...
              <div className="w-40 mx-auto mt-2 md:mt-0 rounded-md">
                <Image
                  src={movieImage}
                  alt="Movie Image"
            ...
            <Card className="h-[350px] md:col-span-3 lg:col-span-2">
              <div className="flex flex-col p-6 md:py-8 md:px-10">
                ...
                <p className="text-sm lg:text-base lg:max-w-xs text-white/60 mt-2">
                  Explore the technologies and tools I used to create digital
                  experiences.
                </p>
              </div>
              <div className="">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-5 lg:grid-cols-3 ">
            <Card className="h-[350px] flex flex-col md:col-span-3 lg:col-span-2">
              <div className="flex flex-col p-6 md:py-8 md:px-10">
                <div className="inline-flex items-center gap-2">
                  <Starticon className="size-9 text-emerald-300" />
              ...
              <div className="relative flex-1" ref={ref}>
                {hobbies.map((hobby) => (
                  <motion.div
                    ...
                    className="absolute cursor-pointer inline-flex items-center gap-2 px-6 bg-gradient-to-r from-emerald-300 to-sky-400 rounded-full py-1.5 "
                    drag
                    dragConstraints={ref}
                  >
            ...
            <Card className="h-[350px] relative md:col-span-2 lg:col-span-1">
              <Image
              ...
              <div className="absolute top-[53%] left-[44%] -translate-x-1/2 -translate-y-1/2 size-14 rounded-full  after:content-[''] after:absolute after:inset-0 after:outline after:outline-2 after:-outline-offset-2 after:rounded-full after:outline-gray-950/30">
